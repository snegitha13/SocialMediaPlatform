...
class CommentControllerTest {
    ...
    public void testCreateComment() {
        ...
        when(commentsService.createComment(anyInt(), anyInt(), anyString())).thenReturn(new ResponseEntity<>("Comment Created", HttpStatus.CREATED));
 
        ResponseEntity<String> response = commentsController.createComment(comment);
    ...
    public void testAddCommentToPost() {
        ...
        ResponseEntity<String> response = commentsController.addCommentToPost(postId, comment);
    ...
    public void testUpdateComment() {
        ...
        when(commentsService.updateComment(anyInt(), anyString())).thenReturn(new ResponseEntity<>("Comment Updated", HttpStatus.ACCEPTED));
 
        ResponseEntity<String> response = commentsController.updateComment(commentId, comment);
